            ...
            list:
                [
                    ...
                    
                    {
                        ...
                        text: "普通公司小项目，传统更新线上代码是每次ftp/sftp上传，或提交到svn/git后再ssh到线上环境中去手动拉取代码，十分麻烦，虽然用上了版本控制，逼格还是不够高啊！现在的线上仓库都支持hook技术，可以很方便的实现代码的自动化管理。比如我现在使用gitee.com仓库的webhook功能，监听master分支有push动作时，可以自动通过设置的hook通知生产环境中的脚本执行git pull拉取代码，自动更新，非常方便...",
                        tags: ['webpack', 'github'],
                        time: '2018-12-21',
                        reads: '21354'
                    },
